    ...
    <div class="container-fluid">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            ...
                                            <a href="<?= base_url('super_admin/detail_berita/'.$row['id_berita']) ?>" class="btn btn-info waves-effect"><i class="fa fa-eye"></i></a>
        ...
        <div class="modal fade" tabindex="-1" role="dialog" id="add">
          <div class="modal-dialog" role="document">
            <?= form_open_multipart("super_admin/berita") ?>
...
<script type="text/javascript">
        ...
        function get_berita(id_berita) {
            $.ajax({
                url: "<?= base_url('super_admin/Berita') ?>",
                type: 'POST',
                data: {
                    id_berita: id_berita,
                    get: true
        ...
        function delete_berita(id_berita) {
            $.ajax({
                ...
                success: function() {
                    window.location = "<?= base_url('super_admin/Berita') ?>";
                }
            });   
        }
        </script>