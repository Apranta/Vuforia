                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body" style="max-height: 250px; overflow-x: scroll;">
                        <ul class="horizontal-slide">
                            ...
                            <li class="col-md-2">
                                <img style="width:150px; " class="thumbnail" src="<?= base_url('assets/img/objek_wisata/'.$val->id_foto.'.jpg') ?>"/>
                                <center>
...
<div class="modal fade" tabindex="-1" role="dialog" id="add">
    ...
    <?= form_open_multipart("super_admin/objek_wisata") ?>
...
<script type="text/javascript">
    ...
    function hapus(id) {
            $.ajax({
                ...
                success: function() {
                    window.location = "<?= base_url('super_admin/detail_objek_wisata/'.$id_objek_wisata) ?>";
                }
            });   
        }
</script>